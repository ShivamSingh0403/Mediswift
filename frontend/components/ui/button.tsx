...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading = false, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-[#0A2540] text-white hover:bg-[#123A63] focus:ring-[#0A2540] shadow-sm hover:shadow-md',
      secondary: 'bg-[#00A896] text-white hover:bg-[#028090] focus:ring-[#00A896] shadow-sm',
      outline: 'border border-slate-200 bg-white text-slate-800 hover:bg-slate-50 hover:border-slate-300 focus:ring-slate-300',
